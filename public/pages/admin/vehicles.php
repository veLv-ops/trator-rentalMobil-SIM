...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($action == 'add') {
        ...
        header('Location: vehicles?success=added');
        exit();
    }
    ...
    if ($action == 'edit') {
        ...
        header('Location: vehicles?success=updated');
        exit();
    }
...
<body>
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <img src="../../images/<?php echo $car['image']; ?>" alt="Car" style="width: 60px; height: 40px; object-fit: cover; border-radius: 4px;">
                                </td>
    ...
    $(document).ready(function() {
        $('#editCarModal').on('show.bs.modal', function (event) {
            ...
            modal.find('#current_image').attr('src', '../../images/' + image);
        });
    });
    </script>
</body>
